...
class ParamedicApp {
    ...
    createTempProject () {
        ...
        exec(this.config.getCli() + ' create ' + this.tempFolder.name + ' ' + this.config.getAppName() + ' ' + utilities.PARAMEDIC_COMMON_CLI_ARGS);
    ...
    installPlugins () {
        ...
        pluginsManager.installSinglePlugin('cordova-plugin-whitelist');
        pluginsManager.uninstallSinglePlugin('cordova-plugin-whitelist');
